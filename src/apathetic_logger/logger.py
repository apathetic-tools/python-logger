...
class ApatheticLogger:
    ...
    class Logger(logging.Logger):
        ...
        def ensure_handlers(self) -> None:
            ...
            if rebuild:
                self.handlers.clear()
                h = ApatheticLogger.DualStreamHandler()
                h.setFormatter(ApatheticLogger.TagFormatter("%(message)s"))
        ...
        def setLevel(self, level: int | str) -> None:  # noqa: N802
            ...
            if isinstance(level, str):
                ...
                if level_upper == "TRACE":
                    level = ApatheticLogger.TRACE_LEVEL
                elif level_upper == "SILENT":
                    level = ApatheticLogger.SILENT_LEVEL
                else:
        ...
        def extend_logging_module(cls) -> bool:
            ...
            logging.addLevelName(ApatheticLogger.TRACE_LEVEL, "TRACE")
            logging.addLevelName(ApatheticLogger.SILENT_LEVEL, "SILENT")

            logging.TRACE = ApatheticLogger.TRACE_LEVEL  # type: ignore[attr-defined]
            logging.SILENT = ApatheticLogger.SILENT_LEVEL  # type: ignore[attr-defined]
        ...
        def determine_log_level(
            ...
            *,
            ...
            env_vars_to_check = (
                _registered_log_level_env_vars
                or ApatheticLogger.DEFAULT_APATHETIC_LOG_LEVEL_ENV_VARS
            )
            ...
            default_level = (
                _registered_default_log_level
                or ApatheticLogger.DEFAULT_APATHETIC_LOG_LEVEL
            )
        ...
        def trace(self, msg: str, *args: Any, **kwargs: Any) -> None:
            if self.isEnabledFor(ApatheticLogger.TRACE_LEVEL):
                self._log(ApatheticLogger.TRACE_LEVEL, msg, args, **kwargs)
