...
3. Open your browser to `http://localhost:4000/python-logging/`

   Note: The baseurl is `/python-logging`, so make sure to include it in the local URL.
...
- `https://apathetic-tools.github.io/python-logging/`
...
- `baseurl`: Set to `/python-logging` (matches the repository name)
